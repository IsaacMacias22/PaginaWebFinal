...
@section('container')
   ...
   <section class="container-fluid">
    <div class="row w-80 mx-auto fila mt-2 text-center">
        <div class="my-2 col-lg-6 col-md-12 col-sm-12 d-flex align-items-center wrap">
            <p class="fs-5">
                <span class="fs-3 d-flex d-block justify-content-center">¿Quiénes somos?</span>
                Somos distribuidores Catel Élite, con más de 20 años
                de experiencia en el mercado de acabados para la
                construcción, enfocados en brindar servicio de 
                suministro eficaz y confiable en cada producto.
                
                Ofrecemos productos a la vanguardia, para las
                distintas necesidades del mercado en calidad y precio.</p>
        </div>
        <div class="my-2 col-lg-6 col-md-12 col-sm-12 d-flex align-items-center wrap">
            <img src="{{asset('img/nosotros.jpg')}}" alt="" width="100%">
        </div>
    </div> 
</section>

<section>
    <div class="container w-75 mx-auto text-center p-3 mt-2" id="sucursal">
        <h1 class="mb-3 fs-2">Conoce nuestra sucursal</h1>
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="1500">
              <img src="{{asset('img/sucursal1.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal2.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal3.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal4.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal5.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal6.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal7.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal8.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal9.jpeg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" data-bs-interval="1500">
              <img src="{{asset('img/sucursal10.jpeg')}}" class="d-block w-100" alt="...">
            </div>
          </div>
